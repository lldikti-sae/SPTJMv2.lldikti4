    ...
    <div class="table-responsive text-nowrap">
        ...
        <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label class="form-label">NIK</label>
                        <input type="text" class="form-control js-editable js-always-readonly" value="{{ $__displayOrNA($dosen->NIK ?? ($dosen->nik ?? null)) }}" readonly style="background-color: #eceef1;">
                    </div>
                    <div class="col-md-6"></div>
                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        @php
                            ...
                            $__ttlDisplay = ($__tglLahir === '' || $__tglLahir === '-' || $__ttl === '' || $__ttl === '-')
                                ...
                                : ($__tglLahir . ' - ' . $__ttl);
                        @endphp
                        <input type="text" name="ttl" class="form-control js-editable js-ttl js-always-readonly" value="{{ $__ttlDisplay }}" readonly disabled style="background-color: #eceef1;" placeholder="Data Tidak Tersedia">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Usia</label>
                        <input type="text" name="usia" class="form-control js-editable js-usia js-always-readonly" value="{{ $__displayOrNA($dosen->Usia ?? null) }}" readonly style="background-color: #eceef1;">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        @endphp
                        <input type="hidden" name="pts" value="{{ $dosen->PTS ?? '' }}" data-sync-pts disabled>
                        <select name="kode_pt" class="form-select js-editable-select js-always-readonly" disabled style="background-color: #eceef1;" required>
                            <option value="" {{ $__kodePtsCurrent === '' ? 'selected' : '' }}>Data Tidak Tersedia</option>
                            @if($__kodePtsCurrent !== '' && !$__kodePtsInList)
                                <option value="{{ $__kodePtsCurrent }}" data-pts="{{ $__namaPtsCurrent }}" selected>{{ $__kodePtsCurrent }} - {{ $__namaPtsCurrent !== '' ? $__namaPtsCurrent : '-' }}</option>
