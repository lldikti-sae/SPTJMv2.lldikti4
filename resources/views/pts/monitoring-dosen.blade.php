...
<div class="md2-page-header">
    <div class="page-titles">
        <h3>Monitoring Pembayaran Dosen</h3>
...
<div class="card md2-card">
    ...
    <form action="{{ route('monitoring-dosen-pts.cari') }}" method="POST">
        @csrf
        <div class="row mb-3 mt-4">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="nidn" value="{{ old('nidn', $nidn ?? '') }}"
                    placeholder="Masukkan NIDN atau NUPTK" required>
            </div>
            <div class="col-sm-2">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" readonly style="background-color: #eceef1;"
                value="{{ $selectedJabatan }} - {{ $transaksi->Aktif == 1 ? 'Aktif' : 'Tidak Aktif' }}">
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
                <input type="text" class="form-control text-start" readonly style="background-color: #eceef1;"
    ...
    <hr>
        ...
        <div class="table-responsive text-nowrap border rounded mb-4">
            <table class="table table-bordered table-hover md2-table m-0">
                <thead style="background-color: #dbdee0;">
                    <tr>
                        <th rowspan="2" class="text-center align-middle">Bulan</th>
                        <th rowspan="2" class="text-center align-middle">Kode Usulan</th>
                        <th rowspan="2" class="text-center align-middle">Pangkat Golongan</th>
                        <th rowspan="2" class="text-center align-middle">Gaji</th>
                        <th colspan="6" class="text-center align-middle">Nominal</th>
