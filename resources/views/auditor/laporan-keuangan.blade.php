...
@section('content')
  <div class="card" style="width: 100%; padding: 10px;">
    ...
    <div class="table-responsive text-nowrap">
      <div class="col-12">
        <div class="card-body">
          <form method="GET" action="{{ url('auditor/laporan-keuangan') }}" id="filterForm">
            <div class="row mb-3">
              <div class="d-inline-flex">
                ...
                <div class="me-2">
                  <input type="text" class="form-control" id="basic-default-nidn" name="nidn" placeholder="Masukkan NIDN/NUPTK" value="{{ request('nidn') }}">
                </div>
                ...
                @if (request()->filled('kode_pt') || request()->filled('nidn'))
                  <a href="{{ route('auditor.laporan-keuangan.export', ['kode_pt' => request('kode_pt'), 'nidn' => request('nidn')]) }}"
      ...
      (function () {
        ...
        $('#myTable').DataTable({
          ...
          drawCallback: function (settings) {
            var json = (this.api && this.api().ajax && this.api().ajax.json) ? (this.api().ajax.json() || {}) : (settings.json || {});
