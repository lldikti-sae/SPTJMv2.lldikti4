...
.btn-aksi-edit:hover   { background:#e68a00; }
.btn-aksi-delete:hover { background:#bb2d3b; }

.dataTables_wrapper .dataTables_info { font-size:0.82rem; color:#8592a3; }
.dataTables_wrapper .dataTables_paginate .paginate_button.current,
.dataTables_wrapper .dataTables_paginate .paginate_button.current:hover { background:#1a56db!important; color:#fff!important; border:none!important; border-radius:6px!important; }
