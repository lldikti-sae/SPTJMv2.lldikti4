...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('pegawaiLengthSelect').addEventListener('change', function() {
    ...
    document.body.addEventListener('click', function(event) {
      if (event.target.closest('.delete-pegawai')) {
        let button = event.target.closest('.delete-pegawai');
