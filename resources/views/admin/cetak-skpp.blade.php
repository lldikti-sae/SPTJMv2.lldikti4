...
<body>
    ...
    <div class="mt-4">
        ...
        <p style="text-align: justify;">
            Berdasarkan Surat dari {{ $detail['pts'] ?? ($dosen->PTS ?? '-') }} Nomor : {{ $detail['nomor_surat_pts'] ?? '..........' }} tanggal {{ $detail['tanggal_surat_pts'] ?? '..........' }} tentang Permohonan SKPP, dan Surat Keterangan Lolos Butuh Nomor : {{ $detail['nomor_surat_lolos_butuh'] ?? '..........' }} tanggal {{ $detail['tanggal_surat_lolos_butuh'] ?? '..........' }} .
        </p>
        ...
        <div class="footer-disampaikan">
            ...
            1. {{ $dosen->Nama ?? '-' }}<br>
            2. Bendahara Pengeluaran/PPABP LLDIKTI Wilayah VI Semarang,<br>
