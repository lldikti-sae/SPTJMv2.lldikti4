            ...
            @endif
                ...
                <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                    ...
                    <div class="d-flex align-items-center flex-grow-1" style="min-width: 0;">
                        <span class="sptjm-nav-title d-none d-md-inline">
                            Dashboard Operator PTS Tahun {{ session('tahun') }} -
                            {{ Auth::guard('pts')->user()->nama_pts }} -
                            {{ Auth::guard('pts')->user()->wilayah }}
                        </span>
                        <span class="sptjm-nav-title d-inline d-md-none" style="font-size:0.9rem;">Dashboard PTS {{ session('tahun') }}</span>
                    </div>
                    <!-- /Title -->
