...
class CreatePSisterTukinTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('p_sister_tukin')) {
            Schema::create('p_sister_tukin', function (Blueprint $table) {
                ...
                $table->primary(['nidn', 'tahun', 'periode']);
    ...
    {
        Schema::dropIfExists('p_sister_tukin');
    }
}
